        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-600 mb-4 max-w-md">
              Comprehensive food and nutrition database API with advanced search capabilities, 
              perfect for developers building health and nutrition applications.
            </p>
            <p className="text-gray-600 text-sm">
              Powered by{' '}
              <a 
                href="https://busybody.io/" 
                target="_blank" 
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/api-status" className="text-gray-600 hover:text-gray-900">
                  API Status
                </Link>
              </li>
              <li>
